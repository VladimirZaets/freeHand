module github.com/VladimirZaets/freehands/backend
...
require (
	...
	github.com/go-pkgz/auth v0.0.0-00010101000000-000000000000
...
replace github.com/go-pkgz/auth => github.com/VladimirZaets/auth v0.0.2
